        ...
        methods: {
            ...
            load(){
              ...
              fetch(`http://localhost:8080/member/stuffs/${this.$route.params.id}`)
                .then(response => response.json())
                .then(stuffView => {this.stuffView=stuffView
                console.log(stuffView.stuff)})
                .catch(error => console.log('error', error));
            }
        },
        mounted() {
            ...
            <main class="d-fl-jf m-b">
                ...
                <form @submit.prevent="upload" method="post" enctype="multipart/form-data" ref="form">
                    ...
                    <div class="select-box">
                        ...
                        <input type="text" class="input-field" id="title" name="title" v-model="this.stuffView.title">
                    </div>
                    ...
                    <div class="select-box2 d-fl">
                        <label for="" class="input-field-txt">인원</label> 
                            <div class="people-count-box">
                                ...
                                <input type="text" class="people-count-num" name="numPeople" id="result" v-model="this.stuffView.numPeople">
                    ...
                    <div id="btn-date" class="select-box d-fl jf-sb">
                        <label for="datetime-local" class="input-field-txt">마감시간</label>
                            <input
                                ...
                                v-model="this.stuffView.deadline"
                                >
                    ...
                    <div class="select-box">
                        ...
                        <input type="text" class="input-field" name="price" id="price" v-model="this.stuffView.price">
                    </div>
                    
                    <div class="select-box">
                        <label for="place" class="input-field-txt">장소</label>
                        <input type="text" class="input-field" name="place" id="place" v-model="this.stuffView.place">
                    </div>
    
                    <div class="select-box">
                        <label for="url" class="input-field-txt">링크</label>
                        <input type="text" class="input-field" name="url" id="url" v-model="this.stuffView.url">
                    </div>
    
                    <div class="select-box select-content d-fl fl-dir-col">
                        <label for="content" class="input-field-txt2">내용</label>
                        <textarea class="input-field input-content" name="content" id="content" cols="30" rows="10" v-model="this.stuffView.content"></textarea>
                    </div>
                </form>
            </main>
